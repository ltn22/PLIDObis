...
parameters = {'limit': 1 }
r = requests.get(url, auth=HTTPBasicAuth(API_USER, API_PASSWORD), params=parameters)
...
while True:
    ...
    for v in resp["data"]:
        ...
        to_bbt("capteurs", "temperature", measure, factor=0.01, period=10, epoch=sending_time)
